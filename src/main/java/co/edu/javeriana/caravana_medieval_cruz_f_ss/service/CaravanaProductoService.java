...
public class CaravanaProductoService {
        ...
        // Caso 5: Agregar producto nuevo a caravana o eliminarlo
        public CaravanaProductoDTO crear(Long caravanaId, Long productoId, int stock) {
                ...
                Optional<CaravanaProducto> existenteOpt = caravanaProductoRepository.findByCaravanaAndProducto(caravana,
                                producto);
        ...
        @Transactional
        public void eliminarProductoDeCaravana(Long caravanaId, Long productoId) {
                Caravana caravana = caravanaRepository.findById(caravanaId)
                                .orElseThrow(() -> new RuntimeException("Caravana no encontrada"));
                ...
                CaravanaProducto existente = caravanaProductoRepository.findByCaravanaAndProducto(caravana, producto)
                                .orElseThrow(() -> new RuntimeException("El producto no está en la caravana"));

                caravanaProductoRepository.delete(existente);
        }
